...
|---|---|---|---|---|---|
| 1 | POST | https://dvwa-production-a515.up.railway.app/setup.php | `user_token` | `3420c7aa50f2e0b6ed9d35daaae4c092` | `create_db` |
...
| 27 | POST | https://dvwa-production-a515.up.railway.app/security.php | `user_token` | `9cf38ec57cb658824775ac2b424531f8` | `security`, `seclev_submit` |
